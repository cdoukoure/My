    ...
    <el-container>
        <el-header>
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>Course overview</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        <el-main>
            <el-card>
                                        ...
                                        <el-row>
                                            ...
                                            <el-col :span="8" style="padding:10px;">
                                                ...
                                                <div style="text-align:center;">
                                                    <el-button type="danger" style="margin:10px auto;" @click="addToCart($store.getters['$_lms/currentCourse'])">Acheter maintenant</el-button> <br/>
                ...
                <el-dialog
                    ...
                    <el-row>
                                ...
                                <el-collapse-item v-for="(section, index) in sections" :key="section.id" :name="index" class="box-section-item">
                                    ...
                                    <div v-if="section.session_or_quizs.length > 0" class="box-session-or-quiz">
                                        ...
                                        <div class="el-steps el-steps--vertical">
                                            <div class="el-step is-vertical" style="flex-basis: 50px;" v-for="(sesQuiz, sesQuizIndex) in $store.getters['$_lms/sectionByIdSessionOrQuizSet'](section.id)" :key="sesQuiz.id">
                        ...
                        <el-col :span="18" style="border-left: 1px solid #CCC;border-top: 1px solid #CCC;">
                            <el-row v-if="$store.getters['$_lms/currentSessionOrQuiz'].type === 'session'">
                                <el-col :span="24" style="padding-left:20px;">
                                    <h2>{{ $store.getters.currentSessionOrQuiz.title }}</h2>
                                </el-col>
                                <el-col :span="24">
                                    <video :src="$store.getters['$_lms/currentSessionOrQuiz'].content" class="avatar" style="width:100%;height:431px;background-color:#EFEFEF;">
                                ...
                                <el-col :span="24" style="padding-left:20px;">
                                    ...
                                    <el-tabs v-model="activeName" @tab-click="handleClick">
                                        ...
                                        <el-tab-pane label="Ressources" name="ressources">
                                            <span v-for="ressource in $store.getters['$_lms/currentSessionOrQuiz'].ressources" :key="id">
                            ...
                            <el-row v-else>
                                <el-col :span="20" style="padding-left:20px;border-top:1px solid #EFEFEF">
                                    <h1>{{ $store.getters['$_lms/currentSessionOrQuiz'].title }}</h1>
                                    <p>{{ $store.getters['$_lms/currentSessionOrQuiz'].description }}</p>
                                    <hr/>
                                </el-col>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      skills () {
        return this.$store.getters['$_lms/currentCourseSkillSet']
      },
      requirements () {
        return this.$store.getters['$_lms/currentCourseRequirementSet']
      }
    },
    methods: {
