<template>
    <el-row :gutter="20">
        <el-col :span="24" v-for="course in courses" :key="course.id">
            <el-card>
                <el-row >
                    ...
                    <el-col :span="16" class="card-body">
                        <el-row>
                            ...
                            <el-col :span="12">
                                ...
                                {{ course.number_of_subscribers }} participants inscrits
                            </el-col>
  ...
  export default {
    ...
    methods: {
      selectCourseSetup (courseId) {
            // alert(courseId)
        this.$store.dispatch('selectCurrentCourse', courseId)
            // alert(JSON.stringify(this.$store.state.currentCourseSetupId))
